...
const TOPICS = [
  ...
  { title: 'How to Generate Reports', body: 'Go to Reports to access four report types: the AI Report Builder (top of page), Giving Reports, Attendance Reports, and Annual Giving Summary. Each report supports filtering by day, month, or year, and can be exported as PDF or CSV/Excel.' },
  { title: 'How to Run an Attendance Report', body: 'On the Reports page, scroll to "Attendance Report". Choose Report By (Month, Specific Day, or Full Year), pick the year/month/day, and optionally filter by a specific service type (Sunday Service, Wednesday Service, etc.). Click "Run Report" to see totals, averages, and a per-service breakdown. Use "Download PDF" for a printable copy or "Download Excel" for a spreadsheet.' },
  { title: 'How to Use the AI Report Builder', body: 'On the Reports page, use the AI Report Builder at the top. Type your request in plain English — for example, "Attendance by month for Wednesday services this year", "Giving by category for March", or "Members who joined in 2026". Press Cmd/Ctrl+Enter or click "Build Report". The AI picks the right data, filters, and grouping; actual numbers come directly from your records (never made up). Export as PDF or CSV.' },
